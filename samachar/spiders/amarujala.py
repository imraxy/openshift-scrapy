...
class AmarujalaSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for news in news:
            ...
            item['title'] = news.xpath(
                "normalize-space(a/text())").extract_first()
            item['url'] = "http://www.amarujala.com" + \
    ...
    def parse_detail_page(self, response):
        ...
        item['shortdesc'] = detailPageSelector.xpath(
            "//div[@id='desc']/div/text()").extract_first()
